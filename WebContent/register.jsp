...
<body>
			...
			<fieldset>
				...
				<div class="form-floating mb-3">
					<input type="text" class="form-control" name="name"
						placeholder="<%=rb.getString("name")%>"
						value="${requestScope.user.name}"> <label for="name"><%=rb.getString("name")%></label>
				</div>
				<div class="form-floating mb-3">
					<input type="text" class="form-control" name="surnames"
						placeholder="<%=rb.getString("surnames")%>"
						value="${requestScope.user.surnames}"> <label
						for="surnames"><%=rb.getString("surnames")%></label>
				</div>
				<div class="form-floating mb-3">
					<input type="email" class="form-control" name="mail"
						placeholder="<%=rb.getString("email")%>"
				...
				<div class="form-floating mb-3">
					<input type="password" class="form-control" name="pass1"
						placeholder="<%=rb.getString("pass")%>"
						value="${requestScope.user.password}"> <label for="pass1"><%=rb.getString("pass")%></label>
				</div>
				<div class="form-floating mb-3">
					<input type="password" class="form-control" name="pass2"
						placeholder="<%=rb.getString("repeat_pass")%>"
						value="${requestScope.pass2}"> <label for="pass2"><%=rb.getString("repeat_pass")%></label>
				</div>
				<div class="form mb-3">
					<label for="provincia"><%=rb.getString("province")%></label> <select
						name="provincia" class="custom-select" id="select-provincia"></select>
				</div>
				<div class="form mb-3">
					<label for="municipio"><%=rb.getString("municipality")%></label> <select
						name="municipio" class="custom-select" id="select-municipio"></select>
				</div>
	...
	<script src="js/form_select.js"></script>
</body>
